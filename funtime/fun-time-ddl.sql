...
CREATE TABLE SCREEN_SEAT (
    ...
    SEAT_TYPE ENUM("REGULAR", "PREMIUM", "EXECUTIVE") NOT NULL,
...
CREATE TABLE SHOW_SEAT (
    ...
    SHOW_SEAT_STATUS ENUM("PENDING", "RESERVED", "CANCELLED", "FAILED", "TIME_EXCEED", "RESEREVED_PAYMENT_AWAIT", "CANCELLED_PAYMENT_FAILURE"),
...
CREATE TABLE NOTIFICATION (
    ...
    NOTIFICATION_BOOKING_ID INT(4) NOT NULL,
    CONSTRAINT PK_NOTIFICATION_ID PRIMARY KEY (NOTIFICATION_ID),
    CONSTRAINT FK_NOTIFICATION_BOOKING_ID FOREIGN KEY (NOTIFICATION_BOOKING_ID) REFERENCES BOOKING (BOOKING_ID)
) ENGINE=InnoDB;
